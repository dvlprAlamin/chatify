  ...
  return (
    <MainTab.Navigator
      ...
      tabBarOptions={{ 
        ...
        indicatorStyle:{backgroundColor:Colors[colorScheme].background, height:3},
      ...
      <MainTab.Screen
        ...
        options={{
          tabBarIcon: ({ color }) => <Entypo name="camera" size={24} color="#fff" />,
          tabBarLabel: ()=> null
        }}
      /> 
      <MainTab.Screen
...
const TabTwoStack = createStackNavigator<StatusParamList>();
